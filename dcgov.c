...
#define MAX_CORRUPT  8      /* Size of corruption rule array */

#define MAX_DIST     20     /* Distance the governeurs can affect the planets */
...
static int corrupts[] = {0, 7, 15, 30, 45, 75, 90, 95}; /* Corruption rule */
static int incomes[] = {100, 93, 85, 70, 55, 25, 10, 5}; /* Income percentage */
